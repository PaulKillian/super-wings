...
SELECT pg_catalog.setval('public."cartItems_cartItemId_seq"', 370, true);
...
SELECT pg_catalog.setval('public."carts_cartId_seq"', 390, true);
...
SELECT pg_catalog.setval('public."orders_orderId_seq"', 95, true);
